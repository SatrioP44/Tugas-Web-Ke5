  ...
  <div class="content-wrapper">
    ...
    <div class="container mt-3">
      ...
      <form method="POST">
          ...
          <input type="text" name="kode_barang" class="form-control" id="kode_barang" value="<?php echo ($data ["kode_barang"]); ?>" readonly>
          </div>
          <div class="mb-3">
          <label for="nama_barang" class="form-label">Nama Barang:</label>
          <input type="text" name="nama_barang" class="form-control" id="nama_barang" value="<?php echo ($data['nama_barang']);?>">
          </div>
          <div class="mb-3">
